...
#define PYENUM(name) {\
	...
	PYENUM(R_ANAL_STACK_ALIGN);
        // R_ANAL_ARCHINFO
        PYENUM(R_ANAL_ARCHINFO_MIN_OP_SIZE);
        PYENUM(R_ANAL_ARCHINFO_MAX_OP_SIZE);
        PYENUM(R_ANAL_ARCHINFO_INV_OP_SIZE);
        PYENUM(R_ANAL_ARCHINFO_ALIGN);
        PYENUM(R_ANAL_ARCHINFO_DATA_ALIGN);
#undef E
}
